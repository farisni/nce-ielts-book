    ...
    <div className="mx-auto flex w-[1022px] min-w-[1022px] flex-none gap-6">
          ...
          <section className="w-[728px] min-w-[728px] max-w-[728px] shrink-0 rounded-md px-6 pb-6 pt-6">
            ...
            <AnimatePresence>
              {activePanelKey && (
                <motion.div
                  className="fixed inset-0 z-[51] bg-black/35"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
            ...
            <AnimatePresence>
              {isNce4 && playing && audioActiveKey && (
                <motion.div
                  className="fixed inset-0 z-[51] bg-black/[0.12] pointer-events-none"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
          ...
          <aside className="article-outline w-[270px] min-w-[270px] max-w-[270px] shrink-0 overflow-hidden flex flex-col gap-6 rounded-md px-4 pb-4 pt-24">
