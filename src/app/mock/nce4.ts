...
const articleNce4L2: Article = {
  ...
  original: {
    paragraphs: [
      [
        { text: "Why, you may wonder, should spiders be our friends?", translation: "你可能会觉得奇怪， 蜘蛛怎么会是我们的朋友呢？", predicates: ["wonder", "be"], clauseIntroducers: [], auxiliaries: ["may"], inlineAnnotations: [{ label: ", you may wonder,", description: "插入语(额外不重要的信息)" }], expansionNotes: [{ label: "插入语 先去掉再翻译或者先翻译（次要信息但会增加阅读难度）", description: "", examples: [{ word: "", meaning: "", enExample: "Why, you may wonder, should spiders be our friends?", zhExample: "" }, { word: "", meaning: "", enExample: "Dogs, it seems, love to chew up money.", zhExample: "" }, { word: "", meaning: "", enExample: "Chickens slaughtered in the United States, claim officials in Brussels, are not fit to grace European tables.", zhExample: "" }, { word: "", meaning: "", enExample: "A man without an education, many of us believe, is an unfortunate victim of adverse circumstances, deprived of one of the greatest twentieth-century opportunities.", zhExample: "" }] }, { label: "should 怎么会", description: "", examples: [{ word: "", meaning: "", enExample: "How should I know?", zhExample: "我怎么会知道？" }, { word: "", meaning: "", enExample: "Why should conservatives vote for Bush?", zhExample: "保守派怎么会投票给布什？" }, { word: "", meaning: "", enExample: "Why should they oppose this plan?", zhExample: "他们怎么会反对这个计划？" }, { word: "You may wonder", meaning: "", enExample: "why spiders are our friends?", zhExample: "" }, { word: "主要信息", meaning: "", enExample: "次要信息", zhExample: "" }] }, { label: "You may wonder... 设问句结构(重点突出wonder)", description: "", examples: [{ word: "", meaning: "", enExample: "You may wonder why he left early.", zhExample: "你可能会想知道他为什么早退。" }, { word: "", meaning: "", enExample: "You may wonder, why should we care about climate change?", zhExample: "你可能想知道，我们为什么要关心气候变化？" }, { word: "", meaning: "", enExample: "You may wonder, why should education be a priority?", zhExample: "你可能会想，为什么教育应该优先？" }] }, { label: "【设问句】写作技巧 引起兴趣，避免说教", description: "", examples: [{ word: "", meaning: "", enExample: "Why should we learn from history?", zhExample: "我们为什么要学习历史？" }, { word: "", meaning: "", enExample: "Why must we rethink our lifestyles?", zhExample: "我们为什么必须重新思考我们的生活方式？" }, { word: "", meaning: "", enExample: "Why do small habits matter so much?", zhExample: "为什么小习惯如此重要？" }, { word: "Building harmonious personal relationships is very important in the modern society.", meaning: "", enExample: "Why, you may wonder, should some of us become experts in building and maintaining personal relationships?", zhExample: "" }, { word: "说教语气（容易让人产生不悦感）", meaning: "", enExample: "设问句开头，引起读者兴趣", zhExample: "" }] }] },
        { text: "Because they destroy so many insects, and insects include some of the greatest enemies of the human race.", translation: "因为它们能消灭那么多的昆虫，其中包括一些人类的大敌", predicates: ["destroy", "include"], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [], expansionNotes: [{ label: "because 因为，用于回答why句", description: "", examples: [{ word: "", meaning: "", enExample: "Because he was late, he missed the bus.", zhExample: "因为他迟到了，他错过了公交。" }, { word: "", meaning: "", enExample: "Because they work hard, they succeed.", zhExample: "因为他们努力工作，所以成功。" }, { word: "", meaning: "", enExample: "Because it rained, we canceled the picnic.", zhExample: "因为下雨了，我们取消了野餐。" }] }, { label: "kill off 杀死、屠杀、灭绝", description: "", examples: [{ word: "", meaning: "", enExample: "Disease wiped out the tribe.", zhExample: "疾病使这个部落灭绝。" }, { word: "", meaning: "", enExample: "What wiped out / exterminated dinosaurs from the earth?", zhExample: "" }, { word: "destroy 毁灭", meaning: "", enExample: "The fire destroyed the whole building. 这场火烧毁了整栋楼。", zhExample: "" }, { word: "kill off 大量杀死", meaning: "", enExample: "Pollution killed off many marine species. 污染导致许多海洋生物大量死亡。", zhExample: "" }, { word: "slaughter / massacre 屠杀", meaning: "", enExample: "The army massacred civilians. 军队屠杀了平民。", zhExample: "" }, { word: "wipe out / exterminate 灭绝", meaning: "", enExample: "Disease wiped out the tribe. 疾病使这个部落灭绝。 What wiped out / exterminated dinosaurs from the earth?", zhExample: "" }] }, { label: "human race 人类(人的总称)", description: "", examples: [{ word: "", meaning: "", enExample: "We must protect the future of the human race.", zhExample: "我们必须保护人类的未来。" }, { word: "", meaning: "", enExample: "The human race has enough weapons to annihilate itself.", zhExample: "人类有足够的武器灭绝自己。" }, { word: "", meaning: "", enExample: "Can the human race carry on expanding and growing the same way that it is now?", zhExample: "人类能够像现在这样继续发展和增长吗？" }, { word: "human being 可数", meaning: "", enExample: "...a puma will not attack a human being unless it is cornered.", zhExample: "" }, { word: "mankind / humankind 不可数", meaning: "", enExample: "Technology benefits all mankind. 科技造福全人类。", zhExample: "" }, { word: "humanity 较正式", meaning: "", enExample: "It was a crime against humanity. 那是反人类罪行。", zhExample: "" }] }] },
        { text: "Insects would make it impossible for us to live in the world; they would devour all our crops and kill our flocks and herds, if it were not for the protection we get from insect-eating animals.", translation: "昆虫就会使我们无法在地球上生活下去，昆虫会吞食我们的全部庄稼，杀死我们的成群的牛羊，要不是人类受一些食虫动物的保护", predicates: ["make", "devour", "kill", "were", "get"], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [{ label: "to live in the world", description: "真正的主语" }, { label: "flocks and herds", description: "群羊和兽群：指一群羊或其他动物的集合，通常用于描述农场或牧场上的动物群。" }], expansionNotes: [{ label: "虚拟语气 § 与事实相反的假设", description: "", examples: [{ word: "", meaning: "", enExample: "If I were rich, I would travel the world.", zhExample: "如果我有钱，我会环游世界。" }, { word: "", meaning: "", enExample: "Had I studied harder, I would have passed the exam.", zhExample: "如果我更努力学习，我本可以通过考试。" }, { word: "", meaning: "", enExample: "Should it rain, we would cancel the trip.", zhExample: "如果下雨，我们会取消旅行。" }] }, { label: "make it possible for sb. to do 使某人能做某事", description: "", examples: [{ word: "", meaning: "", enExample: "They devise hundreds of competitions which will enable us to win huge sums of money. Radio and television have made it possible for advertisers to capture the attention of millions of people in this way.", zhExample: "" }, { word: "", meaning: "", enExample: "The device makes it possible for blind people to read.", zhExample: "这个设备使盲人能够阅读。" }, { word: "", meaning: "", enExample: "Radio makes it possible to reach millions.", zhExample: "广播使得能够接触到数百万人。" }, { word: "", meaning: "", enExample: "His injury rendered him unfit for work.", zhExample: "" }, { word: "", meaning: "", enExample: "Solar power could become a viable energy source, rendering fossil fuels obsolete.", zhExample: "" }, { word: "", meaning: "", enExample: "His promotion rendered him more confident.", zhExample: "他的升职使他更有自信。" }, { word: "enable sb. to do 使某人能够做某事", meaning: "", enExample: "This would enable me to go to Canada. 这可以使我去加拿大了。", zhExample: "" }, { word: "render sb. / sth. + adj. (fml.)使某人能做某事", meaning: "", enExample: "His injury rendered him unfit for work. Solar power could become a viable energy source, rendering fossil fuels obsolete. His promotion rendered him more confident. 他的升职使他更有自信。", zhExample: "" }] }, { label: "flocks and herds 牛羊群", description: "", examples: [{ word: "", meaning: "", enExample: "A flock of sheep grazed on the hill.", zhExample: "一群羊在山坡上吃草。" }, { word: "", meaning: "", enExample: "A herd of cattle crossed the road.", zhExample: "一群牛穿过马路。" }, { word: "", meaning: "", enExample: "They raised large herds of animals.", zhExample: "他们养了很多牲畜。" }, { word: "a flock of sheep / pigeons 羊群 / 鸽群", meaning: "", enExample: "We saw a flock of sheep grazing on the hill. 我们看到一群羊在山上吃草。", zhExample: "" }, { word: "a herd of cattle / deer / elephants 牛群 / 鹿群 / 象群（多指牲畜）", meaning: "", enExample: "A herd of elephants was moving slowly through the forest. 一群大象正缓慢穿过森林。", zhExample: "" }, { word: "a drove of horses / cattle / sheep 被赶着走的一群马 / 牛 / 羊", meaning: "", enExample: "The farmer led a drove of cattle down the road. 农夫赶着一群牛沿着路走。", zhExample: "" }, { word: "a pack of wolves / tigers / lions 狼群 / 虎群 / 狮群（多指猛兽）", meaning: "", enExample: "They were surrounded by a pack of wolves in the forest. 他们在森林中被一群狼包围了。", zhExample: "" }, { word: "a pride of lions 一群狮子", meaning: "", enExample: "We spotted a pride of lions resting in the shade. 我们看到一群狮子在阴凉处休息。", zhExample: "" }, { word: "a swarm of flies / bees 一群苍蝇 / 蜜蜂（飞虫）", meaning: "", enExample: "A swarm of bees flew out of the hive. 一群蜜蜂从蜂巢飞出。", zhExample: "" }, { word: "a colony of ants / termites 蚁群 / 白蚁群", meaning: "", enExample: "We found a colony of ants under the rock. 我们在石头下发现了一群蚂蚁。", zhExample: "" }, { word: "a school / shoal of fish 一群鱼", meaning: "", enExample: "A diver swam through a school of fish. 一名潜水员穿过一群鱼。", zhExample: "" }] }, { label: "if it were not for / but for / except for 要不是、若没有", description: "", examples: [{ word: "", meaning: "", enExample: "If it were not for your help, I couldn’t succeed.", zhExample: "要不是你的帮助，我不会成功。" }, { word: "", meaning: "", enExample: "If it were not for your support, I would be in big trouble now.", zhExample: "" }, { word: "", meaning: "", enExample: "Were it not for your support, I would be in big trouble now.", zhExample: "（倒装）" }] }, { label: "圆周句（掉尾句）特殊结构强调句；一般用于书面语，制造悬念，一般文章不能大量使用", description: "", examples: [{ word: "", meaning: "", enExample: "That all great art has this power of suggesting a world beyond is undeniable.", zhExample: "" }, { word: "", meaning: "", enExample: "Although Tchaikovsky himself thought of the Pathetic Symphony as his crowning masterpiece, the premiere on October 28th 1893 in St. Petersburg proved a disappointment.", zhExample: "" }] }, { label: "insect-eating animals 吃昆虫的动物 = animals which eat insects", description: "", examples: [{ word: "", meaning: "", enExample: "Insect-eating animals such as frogs help control pests.", zhExample: "吃昆虫的动物如青蛙有助于控制害虫。" }, { word: "", meaning: "", enExample: "Birds are insect-eating animals that maintain ecological balance.", zhExample: "鸟类是维护生态平衡的吃昆虫的动物。" }, { word: "", meaning: "", enExample: "Bats belong to insect-eating animals and reduce mosquito populations.", zhExample: "蝙蝠属于吃昆虫的动物，减少蚊子数量。" }, { word: "", meaning: "", enExample: "law-abiding citizens = citizens who abide by the law", zhExample: "" }, { word: "", meaning: "", enExample: "hand-made silverware = silverware which is made by hands", zhExample: "" }, { word: "", meaning: "", enExample: "stress-related diseases = diseases which are related to stress", zhExample: "" }, { word: "state-owned enterprises 国有企业", meaning: "", enExample: "The government is reforming state-owned enterprises. 政府正在改革国有企业。", zhExample: "" }, { word: "flower-selling girls 卖花女孩", meaning: "", enExample: "We were approached by flower-selling girls on the street. 我们在街上遇到了卖花的女孩。", zhExample: "" }, { word: "epoch-making masterpieces 划时代的杰作", meaning: "", enExample: "It is one of the greatest epoch-making masterpieces in history. 这是一部划时代的杰作。", zhExample: "" }, { word: "cancer-causing substances 致癌物质", meaning: "", enExample: "Smoking contains many cancer-causing substances. 香烟中含有许多致癌物质。", zhExample: "" }] }] },
        { text: "We owe a lot to the birds and beasts who eat insects but all of them put together kill only a fraction of the number destroyed by spiders.", translation: "我们要十分感谢那些吃昆虫的鸟和兽，然而把它们所杀死的昆虫全部加在一起也只相当于蜘蛛所消灭的一小部分。", predicates: ["owe", "eat", "kill"], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [{ label: "put together", description: "后置定语，put在这里是过去分词“被放到一块儿了的所有吃昆虫的所有”" }, { label: "destroyed by spiders", description: "后置定语修饰“被蜘蛛杀死的”" }], expansionNotes: [{ label: "owe 欠、感谢", description: "", examples: [{ word: "", meaning: "", enExample: "How much do I owe you?", zhExample: "我欠你多少钱？" }, { word: "", meaning: "", enExample: "You owe him an apology.", zhExample: "你欠他一个道歉。" }, { word: "", meaning: "", enExample: "I owe you one.", zhExample: "我欠你一个人情（IOU）。" }, { word: "", meaning: "", enExample: "I owe you a lot / a great deal.", zhExample: "表达“感谢”" }, { word: "owe A to B 把A归于B", meaning: "", enExample: "I owe my success to good luck. 我把我的成功归功于好运。", zhExample: "" }, { word: "attribute A to B 把A归于B", meaning: "", enExample: "He attributed his failure to bad weather. 他把失败归因于恶劣天气。", zhExample: "" }, { word: "ascribe A to B 把A归于B", meaning: "", enExample: "Scholars ascribe this text to Shakespeare. 学者们将此文归功于莎士比亚。", zhExample: "" }, { word: "put A down to B 把A归因于B（通常是原因解释）", meaning: "", enExample: "I put his success down to hard work. 我把他的成功归因于努力。", zhExample: "" }, { word: "assign A to B 把A分配/指定给B（强调分配责任、任务、角色）", meaning: "", enExample: "The teacher assigned the task to each student. 老师把任务分配给每个学生。", zhExample: "" }, { word: "credit A to B 把A归功于B（强调功劳或贡献）", meaning: "", enExample: "We credit the invention to Thomas Edison. 我们把这项发明归功于托马斯·爱迪生。", zhExample: "" }] }, { label: "beasts who eat insects = insect-eating animals 上文中的同义词替换", description: "", examples: [{ word: "", meaning: "", enExample: "The lorry was loaded with empty beer bottles and hundreds of them slid off the back of the vehicle and on to the road.", zhExample: "上义词；同义词不好替换，用上义词替换" }, { word: "", meaning: "", enExample: "There was also a great deal of machinery on display. The most wonderful piece of machinery on show was Nasmyth's steam hammer.", zhExample: "" }, { word: "", meaning: "", enExample: "Giant pandas are considered a national treasure and the Chinese government are doing their best to protect this endangered species.", zhExample: "" }, { word: "", meaning: "", enExample: "Moreover, in the past two years other nearby cities may have begun to build similar golf courses or resort hotels. Indeed, the fact that Ocean View has already built these facilities might actually portend failure for Hopewell, …", zhExample: "" }] }, { label: "fraction 一小部分 a small amount of sth. …的一小部分", description: "", examples: [{ word: "", meaning: "", enExample: "His shares are now worth only a fraction of their former value.", zhExample: "他的股票现在只值原来价值的一小部分。" }, { word: "", meaning: "", enExample: "It's usually a small fraction of the total.", zhExample: "它通常只是总数的一小部分。" }, { word: "", meaning: "", enExample: "We are lucky in that only the lower fields, which make up a very small proportion of our farm, are effected by flooding, …", zhExample: "" }, { word: "", meaning: "", enExample: "a high / large proportion / percentage of", zhExample: "… 一大部分" }, { word: "", meaning: "", enExample: "a small / tiny proportion / percentage of", zhExample: "… 一小部分" }] }] },
        { text: "Moreover, unlike some of the other insect eaters, spiders never do the least harm to us or our belongings.", translation: "此外，蜘蛛不同于其他食虫动物，它们丝毫不危害我们和我们的财物。", predicates: ["do"], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [{ label: "Moreover", description: "表递进“此外”" }, { label: "unlike some of the other insect eaters", description: "介词短语做状语“不像那些其它吃昆虫的动物们...”" }, { label: "the least harm", description: "用最高级加强语气“没有一点损害”" }, { label: "to us or our belongings", description: "双宾语“对于我们或者我们的财产”" }], expansionNotes: [{ label: "insect eaters 吃昆虫的(再次被替换)", description: "", examples: [{ word: "", meaning: "", enExample: "beasts who eat insects", zhExample: "" }, { word: "", meaning: "", enExample: "insect-eating animals", zhExample: "" }] }, { label: "moreover 此外；递进", description: "", examples: [{ word: "", meaning: "", enExample: "Moreover, spiders never do harm to us.", zhExample: "此外，蜘蛛从不伤害我们。" }, { word: "", meaning: "", enExample: "Moreover, you're a social being.", zhExample: "而且，你是个社会人。" }, { word: "", meaning: "", enExample: "Moreover, there was no evidence of adaptability to the noise.", zhExample: "此外，没有证据表明我们对这种噪音有适应性。" }] }, { label: "to make things / matters worse 更糟的是… （有感情色彩）", description: "", examples: [{ word: "", meaning: "", enExample: "The team has lost the last two games and, to make matters worse, two of its best players are injured.", zhExample: "非谓语动词如果是固定习语，不要考虑主语统一" }, { word: "", meaning: "", enExample: "To make matters worse, the room is rather small, so I have temporarily put my books on the floor.", zhExample: "" }, { word: "", meaning: "", enExample: "During these tests she was able to read a newspaper through an opaque screen and, stranger still, by moving her elbow over a child's game of Lotto she was able to describe the figures and colours printed on it; …", zhExample: "【扩展】stranger still 更奇怪的是" }] }, { label: "unlike 不像；与…不同(dislike 不喜欢)", description: "", examples: [{ word: "", meaning: "", enExample: "Unlike his brother, he is very outgoing.", zhExample: "与他哥哥不同，他很外向。" }, { word: "", meaning: "", enExample: "Unlike most birds, ostriches cannot fly.", zhExample: "与大多数鸟不同，鸵鸟不能飞。" }, { word: "", meaning: "", enExample: "Unlike other cars, this model is electric.", zhExample: "与其他汽车不同，这款车型是电动的。" }] }, { label: "do (no) harm to 对…有(无)害", description: "", examples: [{ word: "", meaning: "", enExample: "These chemicals do harm to your health.", zhExample: "这些化学物质对你的健康有害。" }, { word: "", meaning: "", enExample: "Noise pollution can do harm to wildlife.", zhExample: "噪音污染会对野生动物有害。" }, { word: "", meaning: "", enExample: "Careless disposal of waste does harm to the environment.", zhExample: "乱扔垃圾对环境有害。" }] }, { label: "never do the least harm to 完全无害（Never + 最高级 = 完全...）", description: "", examples: [{ word: "", meaning: "", enExample: "I have no idea what to do next. ⇒ I don’t have the foggiest idea what to do next.", zhExample: "" }, { word: "", meaning: "", enExample: "I have no interest in boxing. ⇒ I don’t have the slightest interest in boxing.", zhExample: "" }, { word: "", meaning: "", enExample: "This doesn't bear the slightest resemblance to anything in real life.", zhExample: "" }, { word: "", meaning: "", enExample: "Vaccines never do the least harm to patients.", zhExample: "疫苗对患者完全无害。" }, { word: "", meaning: "", enExample: "These shoes never do the least harm to hardwood floors.", zhExample: "这些鞋子对硬木地板完全无害。" }, { word: "", meaning: "", enExample: "The software never does the least harm to system performance.", zhExample: "该软件对系统性能完全无害。" }] }, { label: "双否=强肯", description: "", examples: [{ word: "", meaning: "", enExample: "No one can avoid being influenced by advertisements.", zhExample: "" }, { word: "", meaning: "", enExample: "No one knows how long it will last.", zhExample: "" }, { word: "", meaning: "", enExample: "But this does not matter, for, as he has often remarked, one is never too old to learn.", zhExample: "" }, { word: "All of us are influenced by … 所有人都受到影响", meaning: "", enExample: "All of us are influenced by social media. 我们所有人都受到社交媒体的影响。", zhExample: "" }, { word: "No one can avoid being influenced by … 无人能避免被影响（双重否定，加强语气）", meaning: "", enExample: "No one can avoid being influenced by the environment. 没有人能避免受到环境的影响。", zhExample: "" }, { word: "All of us admit that … 我们都承认", meaning: "", enExample: "All of us admit that technology changes our lives. 我们都承认科技改变了生活。", zhExample: "" }, { word: "No one can deny that … 没有人能否认（双重否定加强语气）", meaning: "", enExample: "No one can deny that education is important. 没有人能否认教育的重要性。", zhExample: "" }, { word: "All of us are attracted by … 我们所有人都被…吸引", meaning: "", enExample: "All of us are attracted by beauty and creativity. 我们都被美和创造力吸引。", zhExample: "" }, { word: "No one can resist … 没有人能抗拒（双重否定，加强语气）", meaning: "", enExample: "No one can resist the charm of freedom. 没有人能抗拒自由的魅力。", zhExample: "" }] }] },
        { text: "Spiders are not insects, as many people think, nor even nearly related to them.", translation: "许多人认为蜘蛛是昆虫，但它们不是昆虫，甚至与昆虫毫无关系。", predicates: ["are", "think", "related"], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [{ label: ", as many people think,", description: "as 引导的非限定性定语从句，表正如...(修饰整个主句)" }], expansionNotes: [{ label: "as 正如", description: "", examples: [{ word: "", meaning: "", enExample: "As a poet points out, life is but a dream.", zhExample: "正如一位诗人指出的那样，人生不过是一场梦。" }, { word: "", meaning: "", enExample: "Children, as is always the case, love their mother.", zhExample: "孩子们通常都爱他们的母亲。" }, { word: "", meaning: "", enExample: "She became angry, as many could see.", zhExample: "她生气了，正如许多人所见。" }] }, { label: "非限定性定语从句 补充说明主句内容", description: "", examples: [{ word: "", meaning: "", enExample: "Things can go wrong on a big scale, as a number of people recently discovered.", zhExample: "" }, { word: "", meaning: "", enExample: "As the Commanding Officer explained later, one half of the station did not know what the other half was doing.", zhExample: "" }, { word: "", meaning: "", enExample: "But this does not matter, for, as he has often remarked, one is never too old to learn.", zhExample: "" }, { word: "", meaning: "", enExample: "As is so often pointed out, knowledge is a two-edged weapon.", zhExample: "正如经常指出的，知识是一把双刃剑。" }, { word: "", meaning: "", enExample: "As has been said above, grammar is not a set of dead rules. 如果as引导的非限定性定语从句没有在句首(位于中间或尾部)指代肯定含义的主句（忽略否定词）", zhExample: "" }, { word: "", meaning: "", enExample: "She did not open the box, as her friends feared.", zhExample: "她没有像她朋友担心那样打开盒子 She did not<span style=\"background-color: #ecf0f1;\">, as her friends feared</span>, open the box." }] }, { label: "as VS which 的区别", description: "", examples: [{ word: "", meaning: "", enExample: "as: 更常用于“众所周知/正如预期/大家都清楚”的背景下，语气强烈", zhExample: "" }, { word: "", meaning: "", enExample: "which: 常见于书面语中进行补充、解释、结果说明", zhExample: "" }, { word: "as 引导例句 ① 句首用法", meaning: "", enExample: "As a poet points out, life is but a dream. 正如一位诗人所说，人生不过一场梦。", zhExample: "" }, { word: "as 引导例句 ② 句中插入", meaning: "", enExample: "Children, as is always the case, love their mother. 正如常见，孩子都爱母亲。", zhExample: "" }, { word: "as 引导例句 ③ 句尾说明", meaning: "", enExample: "She became angry, as many could see. 她变得生气，正如许多人所见。", zhExample: "" }, { word: "which 引导例句 ① 补充说明", meaning: "", enExample: "The sun heats the earth, which makes it possible for plants to grow. 太阳加热地球，这使植物得以生长。", zhExample: "" }, { word: "省略结构：as + be + done “as reported”结构", meaning: "", enExample: "As (is) reported, a foreign delegation will visit. 如报道所说，一个外国代表团将到访。", zhExample: "" }, { word: "省略结构：which + be “which was at large”结构", meaning: "", enExample: "A puma (which was) at large was caught. 一只在逃的美洲狮被抓住了。", zhExample: "" }, { word: "用法小结 语义与结构总结", meaning: "", enExample: "as: 更常用于“众所周知/正如预期/大家都清楚”的背景下，语气强烈 which: 常见于书面语中进行补充、解释、结果说明", zhExample: "" }] }, { label: "nor 部分倒装", description: "", examples: [{ word: "", meaning: "", enExample: "Cuba cannot be conquered,nor (can she be) dominated.", zhExample: "nor 引导的并列句省略（倒装时be、情态动词放前面）" }, { word: "", meaning: "", enExample: "It tires not, nor does it boast of its power.", zhExample: "它不会疲倦，也不会夸耀自己的力量（不能省略的，因为不一样）。" }, { word: "", meaning: "", enExample: "If we glimpse the unutterable, it is unwise to try to utter it, nor should we seek to invest with significance that which we cannot grasp.", zhExample: "不能省略的倒装（主谓不同）" }] }] },
        { text: "One can tell the difference almost at a glance, for a spider always has eight legs and an insect never more than six.", translation: "人们几乎一眼就能看出二者的差异，因为蜘蛛都是8条腿，而昆虫的腿从不超过6条。", predicates: ["tell", "has"], clauseIntroducers: [], auxiliaries: ["can"], inlineAnnotations: [{ label: "One", description: "人们（One is never too old to learn.）" }, { label: "at a glance", description: "一眼就..." }], expansionNotes: [{ label: "tell the difference = tell sb. / sth. apart 分辨，区别", description: "", examples: [{ word: "", meaning: "", enExample: "It's hard to tell the identical twins apart.", zhExample: "很难分辨这对双胞胎。" }, { word: "", meaning: "", enExample: "She can tell the difference between genuine and fake jewelry.", zhExample: "她能分辨真假珠宝。" }, { word: "", meaning: "", enExample: "You should learn to tell the difference between good and bad habits.", zhExample: "你应该学会分辨好习惯和坏习惯。" }] }, { label: "省略结构 并列句省略(重复的内容不引起歧义的情况下)", description: "", examples: [{ word: "", meaning: "", enExample: "Paul likes poetry, and Peter (likes) fiction.", zhExample: "Paul喜欢诗歌，Peter喜欢小说。" }, { word: "", meaning: "", enExample: "Paul likes poetry, and I know that Peter likes fiction.", zhExample: "不能省略：因为位置宾语从句内部" }, { word: "", meaning: "", enExample: "He enjoys swimming, and she (enjoys) diving.", zhExample: "他喜欢游泳，她喜欢跳水。" }] }] },
        { text: "How many spiders are engaged in this work on our behalf?", translation: "有多少蜘蛛在为我们效力呢？", predicates: ["are engaged"], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [{ label: "on our behalf", description: "为了我们的利益、好处" }], expansionNotes: [{ label: "be engaged in 忙于（做）某事、从事", description: "", examples: [{ word: "", meaning: "", enExample: "He is engaged in politics / business.", zhExample: "他忙于政治工作、生意。" }, { word: "", meaning: "", enExample: "He is engaged in searching for solutions.", zhExample: "他正忙于寻找解决办法。" }, { word: "", meaning: "", enExample: "Young people are engaged in seeking their identity.", zhExample: "年轻人正忙于寻找自我认同。" }, { word: "", meaning: "", enExample: "Some of the bigger firms are engaged in researches which are of such general and fundamental nature that it is a positive advantage to them not to keep them secret.", zhExample: "" }, { word: "", meaning: "", enExample: "For one thing, being a problem gives you a certain identity, and that is one of the things the young are busily engaged in seeking.", zhExample: "" }] }, { label: "on one’s behalf / on behalf of sb. 为了某人的利益 / 代表某人", description: "", examples: [{ word: "", meaning: "", enExample: "We are raising a fund on behalf of orphans.", zhExample: "我们正在为孤儿募捐。" }, { word: "", meaning: "", enExample: "I beat you on your behalf.", zhExample: "我是为了你打的他。" }, { word: "", meaning: "", enExample: "He delivered a speech on behalf of the government.", zhExample: "他<strong>代表</strong>政府发表了演讲。" }, { word: "", meaning: "", enExample: "On behalf of the department I would like to thank you all.", zhExample: "我谨<strong>代表</strong>本部门感谢大家。" }, { word: "in one’s interest 为了某人的利益", meaning: "", enExample: "Everything we did was in your interest. 我们所做的一切都是为了你的利益。", zhExample: "" }, { word: "in the interest of sb. 为了某人的利益", meaning: "", enExample: "This is in the interest of all parties. 这符合各方利益。", zhExample: "" }] }] },
        { text: "One authority on spiders made a census of the spiders in a grass field in the south of England, and he estimated that there were more than 2,250,000 in one acre; that is something like 6 million spiders of different kinds on a football pitch.", translation: "一位研究蜘蛛的权威对英国南部一块草坪上的蜘蛛作了一次调查。他估计每英亩草坪里有225万多只蜘蛛。这就是说，在一个足球场上约有600万只不同种类的蜘蛛。", predicates: ["made", "estimated", "were", "is"], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [{ label: "on spiders", description: "后置定语(on 某个方面的)" }, { label: "in a grass field", description: "地点状语" }, { label: "in the south of England", description: "后置定义" }, { label: "in one acre", description: "地点状语" }, { label: "something like", description: "大约" }, { label: "on a football pitch", description: "地点状语" }], expansionNotes: [{ label: "on 做后置定语", description: "", examples: [{ word: "", meaning: "", enExample: "Yuan Longping is a leading authority on hybrid rice.", zhExample: "袁隆平是杂交水稻方面的权威。" }, { word: "", meaning: "", enExample: "When he asked if Mr. Lane lived there, the policeman on duty told him that since his defeat, the ex-Prime Minister had gone abroad.", zhExample: "" }] }, { label: "that is (to say) 也就是说；确切地说", description: "", examples: [{ word: "", meaning: "", enExample: "Everybody admires him for his great sense of humour -- everybody, that is, except his six-year-old daughter, Jenny.", zhExample: "" }, { word: "", meaning: "", enExample: "The fare is reduced for children, that is anyone under 15 years old.", zhExample: "" }, { word: "", meaning: "", enExample: "Languages are taught by the direct method, that is to say, without using the student's own language.", zhExample: "" }, { word: "", meaning: "", enExample: "One solution would be to change the shape of the screen, that is, to make it wider.", zhExample: "一种解决方案是改变屏幕的形状，也就是说，把它做得更宽。" }, { word: "", meaning: "", enExample: "I'll meet you in the city, that is, if the trains are running.", zhExample: "我会在市里见你，也就是说，如果火车运行的话。" }, { word: "", meaning: "", enExample: "I loved him — that is, I thought I did.", zhExample: "我爱他——也就是说，我以为我爱他。" }] }, { label: "authority 权威；当局", description: "", examples: [{ word: "", meaning: "", enExample: "When the fire had at last been put out, the forest authorities ordered several tons of a special type of grass seed which would grow quickly.", zhExample: "" }, { word: "", meaning: "", enExample: "The French authorities had the plane packaged and moved in parts back to France.", zhExample: "" }, { word: "", meaning: "", enExample: "There he was picked up by a policeman and sent back to England by the local authorities.", zhExample: "" }, { word: "", meaning: "", enExample: "It is all too easy to blame the railway authorities when something does go wrong.", zhExample: "" }, { word: "", meaning: "", enExample: "The authorities ordered the evacuation.", zhExample: "当局下令疏散。" }, { word: "", meaning: "", enExample: "The local authorities have imposed a curfew.", zhExample: "地方当局实行了宵禁。" }] }, { label: "something like 大约，大概", description: "", examples: [{ word: "", meaning: "", enExample: "Today we can see even his famous clash with the Inquisition in something like its proper perspective.", zhExample: "" }, { word: "", meaning: "", enExample: "The price is something like $300.", zhExample: "价格大约是300美元。" }, { word: "", meaning: "", enExample: "They reached something like an agreement.", zhExample: "他们达成了某种形式的协议。" }, { word: "", meaning: "", enExample: "It looked something like a bear.", zhExample: "它看起来像是一只熊。" }, { word: "some + 数字 大约、大概（口语中常见）", meaning: "", enExample: "There were some 200 people at the concert. 音乐会上大约有 200 人。", zhExample: "" }, { word: "something in the region of + 数字 大约、差不多（书面语）", meaning: "", enExample: "He earns something in the region of $80,000 a year. 他年收入大约八万美元。", zhExample: "" }, { word: "somewhere in the region of + 数字 接近、将近（书面语/正式）", meaning: "", enExample: "The damage is somewhere in the region of £1 million. 损失大概在一百万英镑左右。", zhExample: "" }, { word: "football pitch 足球场", meaning: "", enExample: "They trained hard on the football pitch. 他们在足球场上刻苦训练。", zhExample: "" }, { word: "boxing ring 拳击场", meaning: "", enExample: "The champion entered the boxing ring to cheers. 冠军走进拳击场，观众欢呼。", zhExample: "" }, { word: "skating rink 滑冰场", meaning: "", enExample: "They skated all afternoon on the skating rink. 他们整个下午都在滑冰场滑冰。", zhExample: "" }, { word: "baseball diamond / court 棒球场", meaning: "", enExample: "Same thinghappened on the baseball diamond / court. 垒球场上也发生过同样的事。", zhExample: "" }, { word: "golf course / links 高尔夫球场", meaning: "", enExample: "The hotel also boasts two swimming pools and a golf course / links. 那家宾馆还拥有两个游泳池和一个高尔夫球场。", zhExample: "" }, { word: "bowling alley 保龄球馆", meaning: "", enExample: "There are restaurants, a library, a bowling alley. 这儿有餐厅，一间图书馆，一座保龄球场。", zhExample: "" }] }] },
        { text: "Spiders are busy for at least half the year in killing insects.", translation: "蜘蛛至少有半年在忙于吃昆虫。", predicates: ["are"], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [{ label: "for at least half the year", description: "时间状语" }], expansionNotes: [{ label: "be busy (in) doing sth. 忙于做某事", description: "", examples: [{ word: "", meaning: "", enExample: "Her eyes were fixed on her plate and in a short time, she was busy eating.", zhExample: "" }, { word: "", meaning: "", enExample: "Meanwhile, my tongue was busy searching out the hole where the tooth had been.", zhExample: "" }, { word: "", meaning: "", enExample: "In a short time, I was busy mixing butter and flour, and my hands were soon covered with sticky pastry.", zhExample: "" }, { word: "", meaning: "", enExample: "She is always busy preparing dinner.", zhExample: "她总是忙着准备晚餐。" }, { word: "", meaning: "", enExample: "The workers are busy repairing the road.", zhExample: "工人们正忙着修路。" }, { word: "", meaning: "", enExample: "He was busy writing a report when I called.", zhExample: "我打电话时，他正忙着写报告。" }] }] },
        { text: "It is impossible to make more than the wildest guess at how many they kill, but they are hungry creatures, not content with only three meals a day.", translation: "它们一年中消灭了多少昆虫，我们简直无法猜测，它们是吃不饱的动物，不满意一日三餐。", predicates: ["is", "kill", "are"], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [{ label: "It", description: "形式主语" }, { label: "wildest", description: "unreasonable; without careful thought 胡乱的、离奇的" }, { label: "content", description: "做表语形容词，前面的being被省略了。" }, { label: "three meals a day", description: "一日三餐" }], expansionNotes: [{ label: "guess 猜测（做名词、动词）", description: "", examples: [{ word: "", meaning: "", enExample: "Guess what? I just won the lottery!", zhExample: "猜猜怎么了？我刚中彩票了！" }, { word: "", meaning: "", enExample: "Guess what? John got engaged to Susan!", zhExample: "" }, { word: "", meaning: "", enExample: "Make a guess at who’s knocking the door.", zhExample: "猜猜是谁在敲门（guess做名词）。" }, { word: "", meaning: "", enExample: "Guess who I ran into yesterday?", zhExample: "猜猜我昨天遇见了谁？" }] }, { label: "wild 离奇的；不切实际的", description: "", examples: [{ word: "", meaning: "", enExample: "She had a wild imagination.", zhExample: "她有丰富的想象力。" }, { word: "", meaning: "", enExample: "It’s just a wild guess.", zhExample: "这只是胡乱猜测。" }, { word: "", meaning: "", enExample: "He made some wild accusations.", zhExample: "他做出了一些毫无根据的指控。" }, { word: "", meaning: "", enExample: "The banks were in crisis due to wild speculation by the rich.", zhExample: "这些银行由于富人们的野蛮投机行为而陷入危机。" }, { word: "", meaning: "", enExample: "Working with you is beyond my wildest dreams.", zhExample: "做梦也想不到..." }] }, { label: "more than + n. 超过；不仅仅...", description: "", examples: [{ word: "", meaning: "", enExample: "These days, it is differences in national regulations, far more than tariffs, that put sand in the wheels of trade between rich countries.", zhExample: "" }, { word: "", meaning: "", enExample: "The open sea was deep and mysterious, and anyone who gave more than a passing thought to the bottom confines of the oceans probably assumed that the sea bed was flat.", zhExample: "" }, { word: "", meaning: "", enExample: "This is more than a book — it’s a philosophy.", zhExample: "这不仅仅是一本书，而是一种哲学。" }, { word: "", meaning: "", enExample: "Peace is more than the absence of war.", zhExample: "和平<strong>不仅仅</strong>是没有战争。" }, { word: "", meaning: "", enExample: "The loss is more than we expected.", zhExample: "损失超出了我们的预期。" }] }, { label: "be not content with 不满足于", description: "", examples: [{ word: "", meaning: "", enExample: "She is not content with being an average student.", zhExample: "她不满足于做一个普通的学生。" }, { word: "", meaning: "", enExample: "They are not content with local success — they want to go global.", zhExample: "他们不满足于地方上的成功，想要走向全球。" }, { word: "", meaning: "", enExample: "The company is not content with its current market share.", zhExample: "公司对现有市场份额不满意。" }] }] },
        { text: "It has been estimated that the weight of all the insects destroyed by spiders in Britain in one year would be greater than the total weight of all the human beings in the country.", translation: "据估计，在英国蜘蛛一年里所消灭昆虫的重量超过这个国家人口的总重量。", predicates: ["has been estimated", "be"], clauseIntroducers: [], auxiliaries: ["would"], inlineAnnotations: [{ label: "It has been estimated", description: "据估计" }, { label: "the weight of all the insects", description: "所有昆虫的重量" }, { label: "in Britain", description: "地点状语" }, { label: "in one year", description: "时间状语" }, { label: "the total weight of all the human beings", description: "所有人类的总体重" }, { label: "in the country", description: "地点状语" }], expansionNotes: [{ label: "be estimated (据)估计", description: "", examples: [{ word: "", meaning: "", enExample: "The loss is estimated to reach upwards of 30000 yuan.", zhExample: "据估计损失达30000元以上。" }, { word: "", meaning: "", enExample: "They are estimated to employ around 50, 000 gunmen.", zhExample: "他们估计雇用约50,000名枪手。" }, { word: "", meaning: "", enExample: "The cost to repair it was estimated at $800.", zhExample: "修复的成本估计为800美元。" }, { word: "", meaning: "", enExample: "Adjusted odds ratios were estimated with logistic regression.", zhExample: "用逻辑回归法评估了调整后比率。" }] }, { label: "鼻腔爆破 nasal explosion [t] / [d] + [n]", description: "", examples: [{ word: "Britain", meaning: "", enExample: "mutton", zhExample: "" }, { word: "mountain", meaning: "", enExample: "didn’t", zhExample: "" }] }] }
      ]
    ],
  },
