...
const articleNce4L2: Article = {
  ...
  original: {
    paragraphs: [
      [
        { text: "Why, you may wonder, should spiders be our friends?", translation: "你可能会觉得奇怪， 蜘蛛怎么会是我们的朋友呢？", predicates: [], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [] },
        { text: "Because they destroy so many insects, and insects include some of the greatest enemies of the human race.", translation: "因为它们能消灭那么多的昆虫，其中包括一些人类的大敌", predicates: [], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [] },
        ...
        { text: "We owe a lot to the birds and beasts who eat insects but all of them put together kill only a fraction of the number destroyed by spiders.", translation: "我们要十分感谢那些吃昆虫的鸟和兽，然而把它们所杀死的昆虫全部加在一起也只相当于蜘蛛所消灭的一小部分。", predicates: [], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [] },
        { text: "Moreover, unlike some of the other insect eaters, spiders never do the least harm to us or our belongings.", translation: "此外，蜘蛛不同于其他食虫动物，它们丝毫不危害我们和我们的财物。", predicates: [], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [] },
        { text: "Spiders are not insects, as many people think, nor even nearly related to them.", translation: "许多人认为蜘蛛是昆虫，但它们不是昆虫，甚至与昆虫毫无关系。", predicates: [], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [] },
        { text: "One can tell the difference almost at a glance, for a spider always has eight legs and an insect never more than six.", translation: "人们几乎一眼就能看出二者的差异，因为蜘蛛都是8条腿，而昆虫的腿从不超过6条。", predicates: [], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [] },
        { text: "How many spiders are engaged in this work on our behalf?", translation: "有多少蜘蛛在为我们效力呢？", predicates: [], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [] },
        ...
        { text: "Spiders are busy for at least half the year in killing insects.", translation: "蜘蛛至少有半年在忙于吃昆虫。", predicates: [], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [] },
        { text: "It is impossible to make more than the wildest guess at how many they kill, but they are hungry creatures, not content with only three meals a day.", translation: "它们一年中消灭了多少昆虫，我们简直无法猜测，它们是吃不饱的动物，不满意一日三餐。", predicates: [], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [] },
        { text: "It has been estimated that the weight of all the insects destroyed by spiders in Britain in one year would be greater than the total weight of all the human beings in the country.", translation: "据估计，在英国蜘蛛一年里所消灭昆虫的重量超过这个国家人口的总重量。", predicates: [], clauseIntroducers: [], auxiliaries: [], inlineAnnotations: [] }
      ]
    ],
  },
