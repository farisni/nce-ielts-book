...
const rawContent = fs.readFileSync(
  path.join(process.cwd(), "doc/grammar.md"),
  "utf-8"
);

const grammarContent = rawContent.replace(/^---[\s\S]*?---\n*/, "");

export default function DemoGrammarPage() {
  return (
    <main className="mx-auto w-[1022px] min-w-[1022px] flex-none rounded-md pl-16 pr-[40px] py-6">
      <div className="flex gap-24 items-start">
        <div className="w-full max-w-2xl">
          ...
          ">
            <MarkdownClient content={grammarContent} />
          </article>
        </div>
