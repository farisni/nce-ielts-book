...
export default function FarisPage() {
  return (
    <main className="mx-auto mt-12 w-[880px] min-w-[880px] min-h-[600px] rounded-md border border-dashed border-zinc-300 p-8">
      ...
      <div className="text-base font-semibold mb-4 pt-7 underline decoration-purple-200 decoration-4 underline-offset-3">{AT_LARGE_TITLE_EN} <span className="font-normal text-gray-400 no-underline text-sm">{AT_LARGE_TITLE_CN}</span></div>
      ...
      <div className="text-base font-semibold mb-5 pt-7 underline decoration-emerald-200 decoration-4 underline-offset-3">{SECTION_TITLE_MAIN} <span className="font-normal text-gray-400 no-underline text-sm">{SECTION_TITLE_SUB}</span></div>
      ...
      <div className="text-base font-semibold mb-5 pt-7 underline decoration-blue-200 decoration-4 underline-offset-3">{SECTION_TITLE_2_EN} <span className="font-normal text-gray-400 no-underline text-sm">{SECTION_TITLE_2_CN}</span></div>
