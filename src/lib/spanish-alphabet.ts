...
export const SPANISH_ALPHABET: SpanishLetter[] = [
  { letter: "a", name: "a", example: "amigo", meaning: "朋友" },
  ...
  { letter: "e", name: "e", example: "español", meaning: "西班牙语" },
  ...
  { letter: "i", name: "i", nameNote: "i latina", example: "iglesia", meaning: "教堂" },
  ...
  { letter: "o", name: "o", example: "ojo", meaning: "眼睛" },
  ...
  { letter: "u", name: "u", example: "uva", meaning: "葡萄" },
