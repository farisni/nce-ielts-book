// 从 Training_illustrated_The-English-Alphabetic-Code.pdf 复刻
// 教学顺序排列：元音（红）→ 辅音（蓝），复用 syntheticphonics 网页音频/图片
...
export const PDF_PHONICS_ROWS: PhonemeRow[] = [
 {
  "phoneme": "/a/",
  "type": "vowel",
 ...
 },
 {
  ...
  "cells": [
   ...
   },
   {
    ...
    "unit": "",
    "rowspan": 1,
    "note": "Often pronounced between /i/ and /ee/",
    "audio": null
   },
   {
    "g": "-y",
