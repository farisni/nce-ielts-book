...
export const CONSONANT_GROUPS: PhonicsGroup[] = [
  ...
  },
  {
    name: "双字母组合",
    rules: [
      { pattern: "sh", ipa: "/ʃ/", tone: "blue" },
      { pattern: "ch", ipa: "/tʃ/", tone: "blue" },
      { pattern: "th", ipa: "/θ/ /ð/", tone: "blue" },
      { pattern: "ph", ipa: "/f/", tone: "blue" },
      { pattern: "wh", ipa: "/w/ /h/", tone: "blue" },
      { pattern: "wr-", ipa: "/r/", tone: "blue" },
      { pattern: "kn-", ipa: "/n/", tone: "blue" },
      { pattern: "-mb", ipa: "/m/", tone: "blue" },
      { pattern: "-bt", ipa: "/t/", tone: "blue" },
      { pattern: "gh", ipa: "/f/ /ɡ/", tone: "blue" },
      { pattern: "-dge", ipa: "/dʒ/", tone: "blue" },
      { pattern: "-tch", ipa: "/tʃ/", tone: "blue" },
      { pattern: "-ck", ipa: "/k/", tone: "blue" },
      { pattern: "-ts", ipa: "/ts/", tone: "blue" },
      { pattern: "-ds", ipa: "/dz/", tone: "blue" },
      { pattern: "-ng", ipa: "/ŋ/", tone: "blue" },
    ],
  },
  {
    name: "尾缀与双写",
    rules: [
      { pattern: "-ss", ipa: "/s/", tone: "blue" },
      { pattern: "-ll", ipa: "/l/", tone: "blue" },
      { pattern: "-ff", ipa: "/f/", tone: "blue" },
      { pattern: "-zz", ipa: "/z/", tone: "blue" },
      { pattern: "-nk", ipa: "/ŋk/", tone: "blue" },
      { pattern: "-mp", ipa: "/mp/", tone: "blue" },
      { pattern: "-nd", ipa: "/nd/", tone: "blue" },
      { pattern: "-nt", ipa: "/nt/", tone: "blue" },
      { pattern: "-ld", ipa: "/ld/", tone: "blue" },
      { pattern: "-lf", ipa: "/lf/", tone: "blue" },
      { pattern: "-lk", ipa: "/lk/", tone: "blue" },
    ],
  },
]
