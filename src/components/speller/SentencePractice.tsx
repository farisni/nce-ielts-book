                  ...
                  >
                    ...
                    {group.chars.map((c, i) => {
                      ...
                      if (pron) {
                        ...
                        return (
                          ...
                          >
                            ...
                            {/* 评分下划线：两侧各延伸 0.15em，相邻字母下划线重叠连续 */}
                            <span
                      ...
                      if (c.status === "correct") {
                        ...
                        // 音标课程（有 phoneticFocus）：输入过程中保持紫色，
                        // 答对撒花后/显示答案时只突出练习音素字母（红色）、其余黑色，
                        // 不做音节红黑着色；其他课程：答对撒花后音节红黑相间，显示答案时灰/深灰交替
